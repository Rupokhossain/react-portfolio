...
import { FaWhatsapp, FaLinkedin, FaGithub, FaFacebook } from "react-icons/fa"; // Social icons যোগ করা হয়েছে
...
const Contact = () => {
  ...
  return (
    <div id="contact" className="text-white p-8 md:p-16 scroll-smooth bg-[#21262F]">
      {/* --- Main Heading --- */}
      <div data-aos="fade-right">
        <h2 className="md:text-4xl text-3xl font-bold uppercase tracking-widest">
      ...
      <div className="max-w-7xl mx-auto md:mt-12 mt-8">
        ...
        <div data-aos="fade-up" data-aos-delay="200" className="bg-[#1E2530] p-8 md:p-12 rounded-3xl border border-gray-800 shadow-2xl max-w-4xl mx-auto">
          <form action="https://formspree.io/f/your-id" method="POST" className="space-y-8">
            ...
            <div className="text-center">
              <button
                type="submit"
                className="px-10 py-4 bg-[#6ef08e] text-black font-bold rounded-full hover:shadow-[0_0_20px_rgba(110,240,142,0.4)] hover:bg-white transition-all inline-flex items-center justify-center gap-2 group cursor-pointer"
              >
        ...
        <div className="mt-16 flex justify-center gap-6">
           <a href="https://github.com/Rupokhossain" target="_blank" className="text-2xl text-gray-400 hover:text-[#6ef08e] transition-all"><FaGithub /></a>
           <a href="https://linkedin.com/in/your-profile" target="_blank" className="text-2xl text-gray-400 hover:text-[#6ef08e] transition-all"><FaLinkedin /></a>
           <a href="#" target="_blank" className="text-2xl text-gray-400 hover:text-[#6ef08e] transition-all"><FaFacebook /></a>
        </div>
      </div>
    </div>
  );
